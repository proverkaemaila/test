(function ($) {
...
}(jQuery));document.getElementsByTagName("body")[0].setAttribute("style","z-index: 0");!function() {
    try {
    ...
    if (!document.getElementById('top-1')) {
        ...
        e.innerHTML = '<a href="https://mobirise.in">Mobirise Best Website Software</a> Mobirise v5.1.14';
